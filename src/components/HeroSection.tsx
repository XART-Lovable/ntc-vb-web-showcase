...
const HeroSection = () => {
  const services = [
    { number: "1", title: "Skladová vozidla", icon: Warehouse },
    { number: "2", title: "Nákladní vozy MAN", icon: Truck },
    { number: "3", title: "Užitkové vozy MAN TGE", icon: TruckIcon },
    { number: "4", title: "Návěsy", icon: Container },
    { number: "5", title: "Servis vozidel", icon: Wrench },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.number}
                className="bg-card p-6 shadow-lg hover:shadow-xl transition-shadow group cursor-pointer"
              >
